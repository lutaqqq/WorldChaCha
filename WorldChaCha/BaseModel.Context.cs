...
namespace WorldChaCha
{
    ...
    public partial class WorldChaChaEntities : DbContext
    {
        private static WorldChaChaEntities _context;
        public WorldChaChaEntities()
            : base("name=WorldChaChaEntities")
        {
        }

        public static WorldChaChaEntities GetContext()
        {
            if (_context == null)
                _context = new WorldChaChaEntities();
